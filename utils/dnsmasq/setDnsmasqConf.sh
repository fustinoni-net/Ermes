...
AP_SSID=${AP_SSID}
ADS_BLOCK_UTILS_DIR=${ADS_BLOCK_UTILS_DIR}
TMPL_FILE=${INSTALL_DIR}${DNSMQSQ_UTILS_DIR}conf/dnsmasq.conf.tmpl
INSTALL_DIR=${INSTALL_DIR}
DNSMQSQ_UTILS_DIR=${DNSMQSQ_UTILS_DIR}
...
export AP_INTERFACE JAIL ADS_BLOCK AP_SSID FK_CONN_CHECK INSTALL_DIR ADS_BLOCK_UTILS_DIR
